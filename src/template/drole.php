...
<body class="" style="background: rgb(255, 21, 9);">
<a href="index.php" class="btn btn-primary col-1 mx-auto">Retour à le blog sur les coktails</a>

  
<h1 class="text-center text-dark bg-light m-4 p-2">Le <?php echo $coktailOne->name ?></h1>
<div class="card m-auto p-2" style="width: 40%;">
  ...
  <div class="card-body">
    ...
    <a href="index.php?page=drole_delete.php&id=<?php echo $coktailOne->id ?>" class="btn btn-outline-danger m-2">Supprimer</a>
  </div>
